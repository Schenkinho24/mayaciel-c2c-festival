...
const TequilaWizard: React.FC<TequilaWizardProps> = ({
  onComplete
}) => {
  ...
  return <div className="w-full">
      ...
      <div className="p-6 animate-fade-in bg-white">
        ...
        <WizardNavigation step={step} isSubmitting={isSubmitting} onPrevStep={prevStep} onNextStep={nextStep} onSubmit={handleSubmit} />
      </div>
    </div>;
};
