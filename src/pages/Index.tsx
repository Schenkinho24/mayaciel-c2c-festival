    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-tequila-neutral flex flex-col">
      ...
      <main className="flex-1 container px-4 py-8 md:py-12 mx-auto">
        <div className="max-w-4xl mx-auto mb-8 md:mb-12 text-center">
          ...
          <p className="text-sm md:text-base text-tequila-dark max-w-2xl mx-auto mb-6 md:mb-8">
            Entdecken Sie unsere exklusive Kollektion von Premium Tequilas und beginnen Sie Ihren persönlichen Geschmacksweg.
          </p>
          
          <Button 
            onClick={openWizard} 
            className="bg-[#411701] hover:bg-[#411701]/90 text-white px-4 md:px-6 rounded-md mb-6 md:mb-8 font-medium py-0 text-sm md:text-base"
          >
        ...
        <Modal 
          ...
          className="bg-transparent w-full max-w-[95%] sm:max-w-4xl mx-auto"
        >
